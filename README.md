...
每天花 10 分钟刷论文？太累了。**AI Paper Daily** 帮你自动完成：采集 → 筛选 → 推送，你只看精选结果。
...
进入 `Actions → Daily AI Paper Daily → Run workflow`，点击运行按钮测试一次。
...
- 🐛 [报告 Bug](https://github.com/alloevil/ai-paper-daily/issues/new?template=bug_report.md)
- 💡 [提出建议](https://github.com/alloevil/ai-paper-daily/issues/new?template=feature_request.md)
- 🔧 [提交 PR](https://github.com/alloevil/ai-paper-daily/pulls)
